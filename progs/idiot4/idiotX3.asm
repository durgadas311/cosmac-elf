...
; and B3 WILL branch - 
;
; IDIOT-3, EF3 active high and Q active high at 8C00H;
;
...
;
;  EF3 active HIGH Q active HIGH
EFHI	EQU	1	; 1=active high EF for serial
QHI	EQU	1	; a=active high Q for serial
;
	org	0
...
ZTO1	B3	DAUX		;HRJ M/S card
 ELSE
	BNZ	ZTO1		; MEASURE LENGTH OF 1ST ZERO BIT AFTER START
	BN3	INCR		; BIT (SAME FOR BOTH <CR> AND <LF>)
	INC	ASCII
