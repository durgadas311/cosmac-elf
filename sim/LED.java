...
public abstract class LED extends JPanel {
	public static enum Colors { RED, AMBER, YELLOW, GREEN, BLUE };
	...
	private static final Color btnBlueOff = new Color(0, 0, 40);
	private static final Color btnBlueOn = new Color(0, 0, 255);
